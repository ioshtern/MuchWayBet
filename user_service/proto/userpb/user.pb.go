...
var file_proto_user_proto_depIdxs = []int32{
	...
	5,  // 10: user.UserService.GetUserByUsername:input_type -> user.GetUserByUsernameRequest
	7,  // 11: user.UserService.GetUserByEmail:input_type -> user.GetUserByEmailRequest
	9,  // 12: user.UserService.GetAllUsers:input_type -> user.GetAllUsersRequest
	...
	4,  // 16: user.UserService.GetUserByID:output_type -> user.GetUserByIDResponse
	6,  // 17: user.UserService.GetUserByUsername:output_type -> user.GetUserByUsernameResponse
	8,  // 18: user.UserService.GetUserByEmail:output_type -> user.GetUserByEmailResponse
	10, // 19: user.UserService.GetAllUsers:output_type -> user.GetAllUsersResponse
	12, // 20: user.UserService.UpdateUser:output_type -> user.UpdateUserResponse
