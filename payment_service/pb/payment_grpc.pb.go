...
const (
	...
	PaymentService_GetAllPayments_FullMethodName = "/pb.PaymentService/GetAllPayments"
...
type PaymentServiceClient interface {
	...
	GetAllPayments(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*PaymentsResponse, error)
...
func (c *paymentServiceClient) GetAllPayments(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*PaymentsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *paymentServiceClient) DeletePayment(ctx context.Context, in *DeletePaymentRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type PaymentServiceServer interface {
	...
	GetAllPayments(context.Context, *Empty) (*PaymentsResponse, error)
...
func (UnimplementedPaymentServiceServer) GetAllPayments(context.Context, *Empty) (*PaymentsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllPayments not implemented")
}
func (UnimplementedPaymentServiceServer) DeletePayment(context.Context, *DeletePaymentRequest) (*Empty, error) {
